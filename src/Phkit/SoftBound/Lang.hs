...
sbPtrBaseType = LGAT.PointerType {
...
sbMetaType = LGAT.StructureType {
  LGAT.isPacked = False,
  LGAT.elementTypes = [sbPtrBaseType, sbPtrBoundType]}

_mkSbCall :: LGA.Type -- ^ resultType
...
_mkSbSave retT name args =
  ...
  LGAI.function = Right $ LGAO.ConstantOperand $ LGAC.GlobalReference
    (LGAT.FunctionType {
        ...
        LGAT.argumentTypes = [],
        LGAT.isVarArg = False }) $ LGA.Name name,
...
mkSbCheck ptr ptr_meta ptr_size = _mkSbCall LGAT.VoidType "sbcheck" [
...
maybeGetCheckedPtr (
  LGAI.Call { LGAI.function =
              ...
              LGAI.arguments = [
                ...
                ((LGAO.LocalReference _ arg_ptr_meta), _),
...
mkSbSave ptr_ptr ptr_meta = _mkSbCall LGAT.VoidType "sbsave" [
...
mkSbInit ptr_meta ptr size = ptr_meta LGA.:= _mkSbCall sbMetaType "sbinit" [
  LGAO.LocalReference LGAT.VoidType ptr,
  LGAO.ConstantOperand size ]

-- | ptr_meta = sbcopy(ptr, ptr_meta)
mkSbCopy :: LGA.Name -> LGA.Name -> LGA.Name -> LGA.Named LGA.Instruction
mkSbCopy meta ptr meta0 = meta LGA.:= _mkSbCall sbMetaType "sbcopy" [
  LGAO.LocalReference LGAT.VoidType ptr,
